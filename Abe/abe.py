...
<head>
    ...
    <meta name="description" content="CryptExplorer Crypto Currency Blockchain Explorer: view detailed information on altcoin transactions and blocks: AlienCoin (ALN), AphroditeCoin (APH), BlitzCoin (BLTZ), BONES Coin (Bones), CarpeDiemCoin (DIEM), Coino (CON), CryptoEscudo(CESC), DeleteCoin (DEL), DigiByte (DGB), Einsteinium (EMC2), EmuCoin (EMU), FryCoin (FRY), H2OCoin (H2O), OlympicCoin (OLY), PiCoin (pi), Premine (PMC), ProCoin (PCN), ReddCoin (RDD), RonPaulCoin (RPC),  rotoCoin (Rt2), SaturnCoin (SAT), SherlockCoin (SHC), SiliconValleyCoin (XSV), SocialCoin (SOC),  Vertcoin (VTC)">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.0.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font-awesome.min.css">
    <link rel="stylesheet" href="https://s3.amazonaws.com/cryptexplorer/css/bootstrap-sortable.css">
...
<script>
  ...
  ga('create', 'UA-47058136-1', 'cryptexplorer.com');
  ga('send', 'pageview');
...
<body>
    <nav class="navbar navbar-inverse navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <a class="navbar-brand" href="http://cryptexplorer.com">
                <img src="%(dotdot)s%(STATIC_PATH)scryptexplorer-glyph.png" alt="" height="35">
                CryptExplorer
            </a>
            <ul class="nav navbar-nav navbar-right"><li class='dropdown'><a href='#' class='dropdown-toggle' data-toggle='dropdown'><b class='caret'></b> Blockchains</a><ul class='dropdown-menu'>
                <li><a href="%(dotdot)schain/AlienCoin">AlienCoin - ALN</a></li>
                <li><a href="%(dotdot)schain/AphroditeCoin">AphroditeCoin - APH</a></li>
                <li><a href="%(dotdot)schain/BlitzCoin">BlitzCoin - BLTZ</a></li>
                <li><a href="%(dotdot)schain/BONES">BONES -Bones</a></li>
                <li><a href="%(dotdot)schain/CarpeDiemCoin">CarpeDiemCoin - DIEM</a></li>
                <li><a href="%(dotdot)schain/Coino">Coino - CON</a></li>
                <li><a href="%(dotdot)schain/CryptoEscudo">CryptoEscudo - CESC</a></li>
                <li><a href="%(dotdot)schain/DeleteCoin">DeleteCoin - DEL</a></li>
                <li><a href="%(dotdot)schain/DigiByte">DigiByte - DGB</a></li>
                <li><a href="%(dotdot)schain/Einsteinium">Einsteinium - EMC2</a></li>
                <li><a href="%(dotdot)schain/EmuCoin">EmuCoin - EMU</a></li>
                <li><a href="%(dotdot)schain/FryCoin">FryCoin - FRY</a></li>
                <li><a href="%(dotdot)schain/H2Ocoin">H2Ocoin - H2O</a></li>
                <li><a href="%(dotdot)schain/OlympicCoin">OlympicCoin - OLY</a></li>
                <li><a href="%(dotdot)schain/PiCoin">PiCoin - pi</a></li>
                <li><a href="%(dotdot)schain/Premine">PremineCoin - PMC</a></li>
                <li><a href="%(dotdot)schain/ProCoin">ProCoin - PCN</a></li>
                <li><a href="%(dotdot)schain/RonPaulCoin">ReddCoin - RDD</a></li>
                <li><a href="%(dotdot)schain/rotoCoin">rotoCoin - Rt2</a></li>
                <li><a href="%(dotdot)schain/SaturnCoin">SaturnCoin - SAT</a></li>
                <li><a href="%(dotdot)schain/SherlockCoin">SherlockCoin - SHC</a></li>
                <li><a href="%(dotdot)schain/SiliconValleyCoin">SiliconValleyCoin - XSV</a></li>
                <li><a href="%(dotdot)schain/SocialCoin">Socialcoin - SOC</a></li>
                <li><a href="%(dotdot)schain/VertCoin">Vertcoin - VTC</a></li>
            </ul></ul>
        </div>
    </nav>
    <div class="header">
    ...
    <div class="content">
        %(body)s
        <hr class="clear">
                <a href="http://qoinpro.com/174b1b0e8e07b7fb896b7e4dbe5bf725"><img src="http://cdn.qoinpro.com/Images/Banners/728x90.png" alt="QoinPro.com: Free Bitcoins every 24 hours" border=0 /></a>
        <hr>
        <div class="footer">
            <a href="%(dotdot)sq"><i class="fa fa-code"></i>API</a>
            <a href="mailto:info@cryptexplorer.com"><i class="fa fa-envelope"></i>Contact</a>
            <a href='#' data-toggle='modal' data-target='#infoModal'><i class='fa fa-info'></i>Info</a>
            <a href='%(dotdot)s%(STATIC_PATH)sprivacy.html'><i class="fa fa-lock"></i>Privacy Policy</a>
            <a href='#' data-toggle='modal' data-target='#donationModal'><i class='fa fa-thumbs-o-up'></i>Donate</a>
            <a href='https://twitter.com/CryptExplorer' target="_blank"><i class="fa fa-twitter"></i>@CryptExplorer</a>
     <hr>
     <p style="font-size:small;">CryptExplorer - 2014</p>
        </div>
        <div class='modal fade' id='donationModal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
            <div class='modal-dialog'>
               <div class='modal-content'>
                  ...
                  <p>Please donate to support CryptExplorer</p>
                  <dl>
                  <dt>BTC</dt>
                  <dd>1MLSyC8SLfwHcKFgu2vXF2Z8QQVmBG7GAE</dd>
                  <dt>LTC</dt>
                  <dd>LaFEbuL8faRFjoLbPKeCoWoi6gbZN9gmQo</dd>
                  <dt>VTC</dt>
                  <dd>VtNYr1LNfTD63vbmdRCEiCr3dBpEVqh2rp</dd>
                  <dt>Cryptsy Trade Key</dt>
                  <dd>db3a33a985601d6456a1c0c7dc7b03f6b58f791f</dd>
                  </dl>
                  </div>
        ...
        <div class='modal fade' id='infoModal' tabindex='-2' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
            <div class='modal-dialog'>
               <div class='modal-content'>
                  <div class='modal-header'>
                     <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button>
                  ...
                  <div class='modal-body'>
                  <p>CryptExplorer.com proudly presented by <a href="https://bitcointalk.org/index.php?action=profile;u=107406">candidakefyr</a></p>
                  <dl>
                  <dt>Powered by;</dt>
                  <dd><a href="https://github.com/bitcoin-abe/bitcoin-abe">bitcoin-abe</a> from <a href="http://john-edwin-tobey.org">John Tobey</a></dd>
                  <dd><a href="https://github.com/twbs/bootstrap">bootstrap</a> from <a href="http://twitter.com/mdo">Mark Otto</a> & <a href="http://twitter.com/fat">Jacob Thornton</a></dd>
                  <dd><a href="https://github.com/FortAwesome/Font-Awesome">font awesome</a> from <a href="http://twitter.com/davegandy">Dave Gandy</a></dd>
                  <dd><a href="https://github.com/drvic10k/bootstrap-sortable">bootstrap-sortable</a> from <a href="https://twitter.com/drvic10k">Matus Brlit</a></dd>    
                  <dd><a href="https://github.com/aFarkas/html5shiv">html5shiv</a> from <a href="https://github.com/aFarkas">Alexander Farkas</a></dd>
                  <dd><a href="https://github.com/scottjehl/Respond">respond.js</a> from <a href="http://scottjehl.com">Scott Jehl</a></dd>
                  <dd><a href="https://github.com/jquery/jquery">jquery</a> from <a href="https://jquery.org/team/">jQuery Foundation</a></dd>
                  <dd><a href="https://github.com/moment/moment.git">moment.js</a> from <a href="http://momentjs.com">momentjs.com</a></dd>
                  <dd><a href="http://cdnjs.com">cdnjs</a> from <a href="http://ryankirkman.com">Ryan Kirkman</a> & <a href="http://thomasdav.is">Thomas Davis</a></dd>
                  <dd><a href="http://osscdn.com">osscdn</a> from <a href="http://www.maxcdn.com">maxcdn</a></dd>
                  </dl>
                  </div>
                  <div class='modal-footer'>
                  <button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>
    ...
    <script src='https://s3.amazonaws.com/cryptexplorer/js/bootstrap-sortable.js'></script>
</body>
</html>
"""
...
class Abe:
    ...
    def __call__(abe, env, start_response):
        ...
        status = '200 OK'
        page = {
            "title": 'CryptExplorer: AltCoin Blockchain Explorer',
            "body": [],
            "env": env,
            "params": {},
    ...
    def handle_chains(abe, page):
        page['title'] = 'CryptExplorer: AltCoin Blockchain Explorer'
        page['h1'] = ' '
        body = page['body']
        body += [
    ...
    def _show_block(abe, page, dotdotblock, chain, **kwargs):
        ...
        body += [
            ...
            '<div><small>Transaction Merkle Root</small>', b['hashMerkleRoot'], '</div>\n',
            '<div><small>Time</small>', b['nTime'], ' (', format_time(b['nTime']), ')</div>\n',
            '<div><small>Difficulty</small>', format_difficulty(util.calculate_difficulty(b['nBits'])),
            ' (Bits: %x)' % (b['nBits'],), '</div>\n',

            ['<div><small>Cumulative Difficulty</small>', format_difficulty(
                    util.work_to_difficulty(b['chain_work'])), '</div>\n']
            ...
            ['<div><small>Coin-days Destroyed</small>',
             format_satoshis(b['satoshis_destroyed'] / 86400.0, chain), '</div>\n'],
            ...
            ['<div>sat=',b['chain_satoshis'],';sec=',seconds,';ss=',b['satoshi_seconds'],
             ';total_ss=',b['chain_satoshi_seconds'],';destroyed=',b['satoshis_destroyed']]
            if abe.debug else '',

            '</div>\n']

        body += ['<a href="http://freebitco.in/?r=384697" target="_blank"><img src="http://static1.freebitco.in/banners/468x60-1.png"></a>'
                 '<hr>\n']
    ...
    def handle_block(abe, page):
        ...
        page['title'] = 'Block - CryptExplorer'
    ...
    def handle_tx(abe, page):
        ...
        page['title'] = ['Transaction ', tx_hash[:10], '...', tx_hash[-4:], ' - CryptExplorer']
        body = page['body']

        if not is_hash_prefix(tx_hash):
            body += ['<hr>\n<p class="error">Not a valid transaction hash.</p>']
            return
        ...
        try:
            ...
            body += ['<hr>\n<p class="error">Not in correct format.</p>']
            return
    ...
    def show_tx(abe, page, tx):
        ...
        body += ['<hr class="clear">\n<div class="information">\n<div><small>Hash</small>', tx['hash'], '</div>\n']
        chain = None
        is_coinbase = None
        ...
        for tx_cc in tx['chain_candidates']:
            ...
            body += [
                ...
                '</a> (', format_time(tx_cc['block_nTime']), ')</div>\n']
        ...
        body += [
            '<div><small>Number of inputs</small>', len(tx['in']),
            ' (<a href="#inputs">Jump to inputs</a>)</div>\n',
            '<div><small>Total in</small>', format_satoshis(tx['value_in'], chain), '</div>\n',
            '<div><small>Number of outputs</small>', len(tx['out']),
            ' (<a href="#outputs">Jump to outputs</a>)</div>\n',
            '<div><small>Total out</small>', format_satoshis(tx['value_out'], chain), '</div>\n',
            '<div><small>Size</small>', tx['size'], ' bytes</div>\n',
            '<div><small>Fee</small>', format_satoshis(0 if is_coinbase else
                                     (tx['value_in'] and tx['value_out'] and
                                      tx['value_in'] - tx['value_out']), chain),
            '</div>\n',
            '<div><small></small><a href="../rawtx/', tx['hash'], '">Raw transaction</a></div>\n']
        body += ['<center><a href="http://freebitco.in/?r=384697" target="_blank"><img src="http://static1.freebitco.in/banners/468x60-1.png"></a></center>'
                 '</div>\n<hr class="clear">\n',
    ...
    def handle_address(abe, page):
        ...
        body += ['</div>\n<hr class="clear">\n'
                 '<h2>', address ,'</h2><p>'
                 '<a href="http://www.bitbillions.com/?refid=1MoBhk7TX3JVj4aHp8FFZR6YiaWFKaEw6s" target="_blank"><img src="http://cryptexplorer.com/static/ref.gif" alt="ad" title="Win BTC"></a><hr>'
    ...
    def search_form(abe, page):
        ...
        return [
            ...
            '<span class="input-group-btn"><button class="btn btn-info" type="submit">Search</button></span></div></form>'
            '<hr>'
            '<iframe scrolling="no" style="border: 0; width: 728px; height: 90px;" src="//coinurl.com/get.php?id=24610"></iframe>'
            '<hr></div>\n']

    def handle_search(abe, page):
        page['title'] = 'Search - CryptExplorer'
        q = (page['params'].get('q') or [''])[0]
        if q == '':
            page['body'] = [
